package com.cloudcc.bags.container;
 ...
 */
public class ContainerBlockChest extends Container {


    private TileEntityBlockChest te;
    public ContainerBlockChest(IInventory playerInv, TileEntityBlockChest te){
        this.te = te;
